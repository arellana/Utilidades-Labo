...
q = open(parent+'/Mediciones/Conductor2.txt').read().replace(',', '.') #Remplazo , por .
...
#print(Volt)
np.savetxt(parent+'/Potenciales/Potencial2.txt', Volt, delimiter = ',')
...
#print(Ex)
np.savetxt(parent+'/CamposDiscret/Ex2.txt', Ex, delimiter = ',')
np.savetxt(parent+'/CamposDiscret/Ey2.txt', Ey, delimiter = ',')
...
plt.savefig(parent+'/CamposPlot/Campo2.png')
plt.show()
